...
export default function Login({ navigation }) {
  ...
  return (
      ...
      <LinearGradientMoots display='flex' justifyContent='flex-end' width='100%' height='100%'>
          <StatusBar translucent={true}/>

          <Box display="flex" alignItems="center" h="40%" justifyContent="center">
            <Image source={image} alt='logo' w={200} h={200}/>
          </Box>
        <ScrollView contentContainerStyle={{borderTopLeftRadius: 50, borderTopRightRadius: 50, backgroundColor: 'white', alignItems: 'center', height: '100%'}}>
            ...
            <Box alignItems="center" w="85%">
                ...
                <Box flexDirection="row" justifyContent="center" mt={2.5} mb={100}>
